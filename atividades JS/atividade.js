...
// Crie um programa que receba dois números e verifique se seu produto é par ou misto.
deixe  num1  =  15 ;
deixe  num2  =  3 ;
...
switch ( diaNum )  {
    ...
    caso  7 :
        ...
        quebrar ;
    padrão :
        console . log ( "Número inválido. O número deve ser 1 - 7." ) ;
}